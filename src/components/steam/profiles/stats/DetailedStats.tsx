...
const DetailedStats = (props: Props) => {
	...
	return (
		<div className="flex flex-col w-full">
			...
			<div className="grid grid-cols-1 gap-2 md:grid-cols-2 w-full mt-8">
				<StatsSection
					...
					data={[
						{
							...
							highestMatchId:
								csgoProfile.gameHighest.kills.matchId,
							standardDeviation:
						...
						},
						{
							...
							highestMatchId:
								csgoProfile.gameHighest.deaths.matchId,
							standardDeviation:
				...
				<StatsSection
					...
					data={[
						...
						},
						{
							...
							highestMatchId:
								csgoProfile.gameHighest.mvps.matchId,
							standardDeviation:
						...
						},
						{
							...
							highestMatchId:
								csgoProfile.gameHighest.score.matchId,
							standardDeviation:
						...
						},
						{
							...
							highestMatchId:
								csgoProfile.gameHighest.ping.matchId,
							standardDeviation:
